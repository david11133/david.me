...
The size affects how long you'll work and how much you get paid. Bigger project = more time, more effort, and more money.
...
You can switch the year in the URL. When you click any org, you'll find their website, GitHub repo, and maybe communication channels (mailing list, etc.). You can connect with them from there.
...
You can filter orgs based on languages, technologies, categories, etc. Try to narrow it down to 2–3 orgs max.

**Important tip:** Focus on orgs that participated in recent years. If an org disappeared for 2+ years, chances are it won't come back.

## Start Engaging Early

Once you pick your orgs, go through their GitHub, read about their projects, try to understand what's going on and how they communicate. Then pick a project you actually find interesting.
...
Work on 1 or 2 projects max. More than that and you'll just burn out or do everything poorly. I would even say try to work on only one project.

## Writing the Proposal

When applications open, you'll need to write your proposal. This is where you explain:
